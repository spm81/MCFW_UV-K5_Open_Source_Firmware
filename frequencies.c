...
const struct FrequencyBandInfo FrequencyBandTable[7] = {
  //  [BAND1_50MHz] = {.lower = 1500000, .upper = 10799990},
    [BAND1_50MHz] = {.lower = 0, .upper = 10799990},
  ...
  //  [BAND7_470MHz] = {.lower = 47000000, .upper = 134000000},
    [BAND7_470MHz] = {.lower = 47000000, .upper = 650000000},
};

const uint16_t StepFrequencyTable[19] = {
    1,   5,   10,  25,  50,  100,

    125, 250, 500, 625, 833, 1000, 1250,  1500, 2000, 2500, 3000, 5000, 10000
};
const uint32_t upConverterValues[] = {0, 5000000, 7000000, 10600000, 12500000, 14000000, 20000000};
